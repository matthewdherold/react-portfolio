...
function Home() {
  ...
  <div id="homeImgDiv">
  <img src=".\Assets\jsLogo.png" alt="logo" className="badgeImgs" id=""/>
  <img src=".\Assets\nodeLogo.png" alt="logo" className="badgeImgs" id=""/>
  <img src=".\Assets\reactLogo.png" alt="logo" className="badgeImgs" id=""/>
  <img src=".\Assets\gitLogo.jpg" alt="logo" className="badgeImgs" id=""/>
  <img src=".\Assets\cssLogo.png" alt="logo" className="badgeImgs" id=""/>
  <img src=".\Assets\htmlLogo.png" alt="logo" className="badgeImgs" id=""/>
</div>
    </div>
  <p id="aboutMe"> 
